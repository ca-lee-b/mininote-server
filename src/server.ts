...
const corsOptions: CorsOptions = { origin: process.env.FRONTEND_URL, credentials: true, allowedHeaders: ["Content-Type", "Cookie", "Accept", "Origin", "Authorization"], methods: "OPTIONS,GET,PUT,PATCH,POST,DELETE" }
